...
impl PlaneRenderer {
    pub fn new(
        ...
        unsafe {
            ...
            let stride = 5 * mem::size_of::<GLfloat>() as i32;
            gl::VertexAttribPointer(0, 3, gl::FLOAT, gl::FALSE, stride, ptr::null());
            gl::EnableVertexAttribArray(0);
            let tex_start = 3 * mem::size_of::<GLfloat>() as i32;
            gl::VertexAttribPointer(1, 2, gl::FLOAT, gl::FALSE, stride, tex_start as *mut c_void);
    ...
    pub fn draw(
        ...
        unsafe {
            ...
            for plane in planes {
                let transform = plane.transform.to_matrix4();
                gl::UniformMatrix4fv(
